...
<article class="post-entry">
	...
	<a href="<?php echo esc_url( get_the_permalink( get_the_ID() ) ); ?>" class="post-image"><img alt="" src="<?php echo esc_url( polo_theme_thumb( $product_thumbnail, '1200', '800', true ) ) ?>"></a>
