...
if(!class_exists('Ultimate_ParamHeading_Param'))
{
	class Ultimate_ParamHeading_Param
	{
		...
		function ult_param_heading_callback($settings, $value)
		{
			...
			$output .= '<input type="hidden" name="'.$settings['param_name'].'" class="wpb_vc_param_value ultimate-param-heading '.$settings['param_name'].' '.$settings['type'].'_field" value="'.$value.'" />';
			return $output;
		}
