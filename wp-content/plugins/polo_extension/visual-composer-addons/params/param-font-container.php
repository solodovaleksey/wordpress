...
class Crum_Font_Container {
	...
	function __construct() {
		if ( function_exists( 'vc_add_shortcode_param' ) ) {
			vc_add_shortcode_param( 'crumina_font_container', array(
					$this,
					'vc_font_container_form_field'
			...
			if ( isset( $fields['tag'] ) ) {
                ...
                <div class="vc_col-' . $columns . ' ">
                    ...
                    <div class="vc_font_container_form_field-tag-container">
                        <select class="crum-select-styled vc_font_container_form_field-tag-select wpb_vc_param_value">';
