...
if(post_type_exists( 'product' ) && is_singular( 'product' ) && is_active_sidebar('shop-1') || function_exists('is_shop') && is_shop() || is_page_template('page-templates/shop-page.php')):?>
